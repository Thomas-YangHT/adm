<?php 
    ...
    //配置项
	$DC_NAME="cmpbind_bind_1";
	$DH_IP="192.168.254.110";
	$DIR="/etc/bind/";
	$CONF=$DIR."\*conf";
	...
	$CMD_TEST="sudo -u root ssh ".$DH_IP." docker cp  /opt/bind/bind/etc/.  ".$DC_NAME.":/etc/bind/ 2>&1;sudo -u root ssh ".$DH_IP." docker exec ".$DC_NAME." named-checkconf 2>&1";
