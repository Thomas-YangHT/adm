...
<aside class="Hui-aside">
	...
	<div class="menu_dropdown bk_2">
		<dl id="menu-article">
			...
			<dd>
				<ul>
					  ...
					  <li><a data-href='http://hgrafana.yunwei.edu'  data-title="[grafana]"       href="javascript:void(0)" >[Grafana]</a></li>
					  <li><a data-href='http://hzabbix.yunwei.edu'     data-title="[zabbix]"     href="javascript:void(0)" >[zabbbix]</a></li>
					 <!-- <li><a data-href='redisinfo.php'              data-title="[redis状态]"       href="javascript:void(0)" >[redis状态]</a></li> -->
					  <li><a data-href='http://hsmokeping.yunwei.edu/smokeping/smokeping.fcgi?target=Other'    data-title="[到各地网络状况]"     href="javascript:void(0)" >[到各地网络状况]</a></li>
					...
					-->
  					  <li><a data-href='http://hscope.yunwei.edu:4040'    data-title="[weave scope 管理]"     href="javascript:void(0)" >[scope]</a></li>	
                      <li><a data-href='http://hdownload2.yunwei.edu'    data-title="[http下载]"       href="javascript:void(0)" >[http下载]</a></li> 					  
		...
		<dl id="menu-article">
			...
			<dd>
				<ul>
					  <li><a data-href='http://hawstats.yunwei.edu/awstats.pl?config=grafana'    data-title="[访问日志grafana]"        href="javascript:void(0)" >[访问grafana]</a></li>
					  <li><a data-href='http://hawstats.yunwei.edu/awstats.pl?config=zahbix'     data-title="[访问日志zabbix]"         href="javascript:void(0)" >[访问zabbix]</a></li>
					  <li><a data-href='http://hawstats.yunwei.edu/awstats.pl?config=download'   data-title="[访问日志download]"       href="javascript:void(0)" >[访问download]</a></li>
